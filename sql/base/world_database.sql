...
MySQL - 5.5.29-30.0-log : Database - 505_world
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`505_world` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
CREATE TABLE `creature` (
  ...
  KEY `idx_map` (`map`),
  KEY `idx_id` (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=1330545 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='Creature System';
...
CREATE TABLE `game_tele` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=1561 DEFAULT CHARSET=utf8 COMMENT='Tele Command';
...
CREATE TABLE `gameobject` (
  ...
  `isActive` tinyint(1) unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`guid`)
) ENGINE=MyISAM AUTO_INCREMENT=734902 DEFAULT CHARSET=utf8 ROW_FORMAT=FIXED COMMENT='Gameobject System';
...
CREATE TABLE `quest_template` (
  ...
  `RequiredFactionKills` mediumint(8) NOT NULL,
  `RequiredFactionKillsCount` smallint(5) NOT NULL,
  `RequiredPetBattleWith` mediumint(8) NOT NULL,
  ...
  `RequiredNpcOrGo5` mediumint(8) NOT NULL,
  ...
  `RequiredNpcOrGoCount5` smallint(5) NOT NULL,
...
CREATE TABLE `spell_area` (
  ...
  `quest_start_active` tinyint(3) unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE `zone_skip_update` (
  ...
  PRIMARY KEY (`zone`)
) ENGINE=InnoDB AUTO_INCREMENT=1638 DEFAULT CHARSET=latin1 COMMENT='latin1_swedish_ci';
