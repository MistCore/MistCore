        ...
        struct npc_simon_bunnyAI : public ScriptedAI
        {
            ...
            */
            void StartGame()
            {
                ...
                MistCore::AllWorldObjectsInRange objects(me, searchDistance);
                MistCore::WorldObjectListSearcher<MistCore::AllWorldObjectsInRange> searcher(me, ClusterList, objects);
